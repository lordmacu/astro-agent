...
class RememberTool extends AstroTool {
...
/// Lets the brain look up things Astro saved earlier. Read-only.
class RecallTool extends AstroTool {
  ...
  @override
  String get description =>
      'Look up what Astro saved before about the driver, the car, or past '
